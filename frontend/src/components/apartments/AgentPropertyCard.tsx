...
import { Bed, Bath, Square, MapPin, Heart, Share2, Verified, Trash2, AccessibilityIcon } from "lucide-react";
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow group">
      ...
      <div className="flex gap-2 m-4">
            ...
            {/* <Button size="sm" variant="outline" className="flex-1 bg-blue-500" onClick={sendRequest}>
              <AccessibilityIcon className="w-4 h-4 mr-1" />
              Request to access
            </Button> */}
          </div>
    </Card>
